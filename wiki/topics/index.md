...
- [NVIDIA Distributed Communication](./nvidia-distributed-communication.md): 调研 NVIDIA 多机多卡通信方式，解释 CUDA、NCCL、NVLink/NVSwitch、InfiniBand/RoCE、GPUDirect RDMA、NVSHMEM、UCX 和 Multi-Node NVLink 的分层关系。
