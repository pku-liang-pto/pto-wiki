...
| `pypto_top_level_documents` | evidence-only | `linqu_runtime_design.md` at commit `7faac0b910e40989a6bbd381a80595b65ab29708`; partial | create profile if top-level design docs become a primary reading path |
