...
| Important examples should record entrypoints, environment assumptions, whether they were locally run, and caveats. | PyPTO README/docstrings; PTO-ISA demo READMEs and `run.sh`; simpler README, L2 example README, L3 pytest markers. | [Examples Feature Map](../topics/examples-feature-map.md#run-surface-and-caveats) |
