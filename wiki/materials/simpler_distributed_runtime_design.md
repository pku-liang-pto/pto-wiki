...
The `simpler` runtime is the **implementation** of the Linqu runtime. This design (simpler Phase 2) extends simpler's existing L0-L2 capabilities to L3, as described in [linqu_runtime_design.md](https://github.com/hengliao1972/pypto_top_level_design_documents/blob/main/linqu_runtime_design.md) Section 3:
